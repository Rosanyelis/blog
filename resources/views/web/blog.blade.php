                            ...
                            <div class="row">
                                <div class="blog-thumbnail col-md-8">
                                    <div class="blog-thumbnail-bg col-md-8 visible-md visible-lg"
                                        style="background-image: url({{ $item->url_imagen }});"></div>
                                    <div class="blog-thumbnail-img visible-xs visible-sm"><img alt=""
                                            class="img-responsive" src="{{ $item->url_imagen }}"></div>
                                </div>
                                <div class="blog-info col-md-4">
                                    ...
                                    <div class="text-right"><a href="{{ route('blog-details', $item->id) }}" class="read-more">Read more</a></div>
                                </div>
                            </div>
                        </article>
                    @endforeach
