                    ...
                    <div class="row">
                        <div class="col-primary col-md-8">
                            <article class="post">
                                ...
                                <div class="post-thumbnail">
                                    <img alt="" class="img-responsive" src="{{ $post->url_imagen }}">
                                </div>
                                {!! $post->contenido !!}
                        ...
                        <div class="col-secondary col-md-4">
                            <div class="widget widget_recent_post">
                                ...
                                <article class="recent-post">
                                    <div class="recent-post-thumbnail">
                                        <a href="{{ route('blog-details', $item->id) }}">
                                            <img alt="{{ $item->titulo }}" src="{{ $item->url_imagen }}" class="wp-post-image">
                                        </a>
                                    </div>
                                ...
                                <!-- <article class="recent-post">
                                    <div class="recent-post-thumbnail">
                                        <a href=""><img alt="" src="img/security1.avif" class="wp-post-image"></a>
                                    </div>
                                    <div class="recent-post-body">
                                        <h4 class="recent-post-title">
                                            <a href="">Creativity can provide all that which is required make your
                                                advertising an</a>
                                        </h4>
                                ...
                                <article class="recent-post">
                                    <div class="recent-post-thumbnail">
                                        <a href=""><img alt="" src="img/video1.avif" class="wp-post-image"></a>
                                    </div>
                                    <div class="recent-post-body">
                                        <h4 class="recent-post-title">
                                            <a href="">Creativity can provide all that which is required make your
